...
dialog_dl_desc_fr="Nous devons télécharger le programme d'installation de macOS sur votre ordinateur ; cela prendra quelques minutes.."
...
dialog_erase_desc_fr="La préparation du programme d'installation peut prendre jusqu'à 30 minutes. Une fois terminé, votre ordinateur va redémarrer et poursuivre la réinstallation.."
...
dialog_reinstall_desc_fr="Ce processus peut prendre jusqu'à 30 minutes. Une fois terminé, votre ordinateur va redémarrer et commencer la mise à niveau.."
...
dialog_confirmation_desc_fr="Veuillez confirmer que vous voulez EFFACER TOUTES LES DONNÉES DE CET APPAREIL et réinstaller macOS."
...
dialog_check_desc_fr="La mise à niveau de macOS ne peut pas être installée car il n'y a pas assez d'espace sur le disque.."
...
dialog_power_title_fr="Attente de la connexion de l'alimentation secteur"
...
dialog_power_desc_fr="Veuillez connecter votre ordinateur à une source de courant à l'aide d'un adaptateur secteur. Ce processus se poursuivra une fois l'alimentation détectée."
...
dialog_short_name_fr="Veuillez entrer un nom de compte pour lancer le processus de réinstallation."
...
dialog_not_volume_owner_fr="Le compte n'est pas un propriétaire de volume ! Veuillez vous connecter avec l'un des comptes suivants et réessayer."
...
dialog_invalid_password_fr="ERREUR : Le mot de passe saisi n'est PAS le mot de passe pour"
...
dialog_get_password_fr="Veuillez entrer le mot de passe du compte"
